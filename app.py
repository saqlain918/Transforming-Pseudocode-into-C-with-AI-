...
st.sidebar.write(f"✅ Vocabulary loaded ({len(vocab)} tokens)")
...
st.sidebar.write("✅ Models successfully loaded!")
...
# Streamlit UI
st.title("🔄 Code Translator: C++ & Pseudocode")
st.write("Convert between C++ and Pseudocode seamlessly!")
...
with col1:
    if st.button("Translate to Pseudocode 📝"):
        ...
        output_area.code(translated_code, language="python")
...
with col2:
    if st.button("Translate to C++ 💻"):
        ...
        output_area.code(translated_code, language="cpp")

st.sidebar.write("📌 **Instructions:**")
st.sidebar.write("1️⃣ Paste your code in the left box.")
st.sidebar.write("2️⃣ Click the respective translation button.")
st.sidebar.write("3️⃣ The translated output appears on the right.")
